...
GRegistration::~GRegistration()
{
	...
	int GRegistration::getFinalNumIteration() { return nr_iterations_; }

	bool GRegistration::hasConverged() { return converged_; }


	/*inline*/ Eigen::Matrix<float, 4, 4> GRegistration::getFinalTransformation()
	{	
