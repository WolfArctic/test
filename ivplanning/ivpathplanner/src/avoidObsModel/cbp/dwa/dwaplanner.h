...
public:
    ...
    int collisiondetection(std::vector<sVehicleStatus> ego, sorted_tree &obspts, sVehicleElem vehiclemodel);
    ...
    */
    ...
    void obstaclemodify(ivmap::ivmapmsgstcell objs, sorted_tree &nearestobs, 
    sorted_tree &rawobs, sorted_tree &dilatedobs);
    ...
    ivpathplanner::path ReverseInterface(ivmap::ivmapmsglocpos ivlocpos,
    ivpathplanner::path current, sorted_tree sortedobjs);

    int TurningBehavior(ivmap::ivmapmsglocpos ivlocpos, ivpathplanner::path current,
...
private:
    ...
    ivlocmsg::ivsensorgps iabasemapBR;
    std::string mapPath;
    double gicsCellSize;
